...
function calculateCoins() {
  ...
  document.getElementById('calculatedAmount').innerHTML = "<b>Number of coins:</b> " + amountVal/coinVal
    + coinType + " @ $" + coinVal + "/" + coinType;

  document.getElementById('calculatedAmountBox2').innerHTML = "<b>Cost of coins:</b> &emsp;&nbsp;&nbsp;" + "$" + parseFloat(Math.round(bitcoinAmountVal*coinVal*100)/100).toFixed(2)
